...
def scatter(nr_con):
    ...
    if nr_con:
        ...
        data2 = pd.read_csv("data_plotting/nrcon/2_nrcon_scatter.csv", dtype='float', header=None, delimiter=';')
